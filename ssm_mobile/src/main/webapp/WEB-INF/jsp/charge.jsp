      ...
      <TABLE cellSpacing=0 cellPadding=0 width=173 border=0>
        ...
        <TR>
          <TD width=11 bgColor=#2650a6><IMG height=1 
            src="images/blank.gif" width=1 border=0><img src="images/Arrow1.gif" width="23" height="23"></TD>
          <TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A 
            class=nav href="addNum9">资源管理</A></TD>
        </TR>
        <TR>
          <TD bgColor=#ffffff colSpan=2><IMG height=1 
            src="images/blank.gif" width=1 border=0></TD></TR>
...
<h2>收费细项</h2>
    <form method="POST" action="">
      <p>收费项目：<select size="1" name="D1" id="kind">
      ...
      <p>收费金额：<input type="text" name="T1" size="20" id="price"></p>
    ...
    <form method="POST" action="insert2">
      ...
      <p>收费项目：<input type="checkbox" name="C1" value="A" checked>开户费 
      <input type="checkbox" name="C1" value="B">漫游费 <input type="checkbox" name="C1" value="C">押金 
      <input type="checkbox" name="C1" value="D" checked>入网费 <input type="checkbox" name="C1" value="E" checked>选号费</p>
      <p><input type="submit" value="提交" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>   
