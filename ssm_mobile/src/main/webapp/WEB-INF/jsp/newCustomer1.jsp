...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="add2">
      <p>证件类型：${id_Type}</p>
      <p>证件号码：${id_Number}</p>
      <p>姓名：<input type="text" name="customer_Name" size="20" placeholder="请输入用户名"></p>
      <p>性别：<input type="radio" value="男" checked name="customer_Sex" selected>男&nbsp;&nbsp; <input type="radio" name="R1" value="女">女</p>
      <p>生日：<input type="text" name="customer_Birth" size="20" placeholder="如：2000-0-0" ></p>
      <p>联系地址：<input type="text" name="customer_Addre" size="20" placeholder="身份证地址"></p>
      <p>　</p>
