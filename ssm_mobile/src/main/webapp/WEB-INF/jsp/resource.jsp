...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="addMobileNum">
    <p>号码类型：<input type="Radio" name="MType" value="SIM" checked>SIM &nbsp;&nbsp;<input type="Radio" name="MType" value="UIM">UIM</p>
    <p>指定号段：从<input type="text" name="T1" size="20" placeholder="请输入7位数字">到<input type="text" name="T2" size="20" placeholder="请输入7位数字"><input type="submit" value="提交" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>
    <hr>
