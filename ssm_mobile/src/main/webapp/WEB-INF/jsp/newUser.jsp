  ...
  <TR vAlign=top>
    <TD height="600" bgColor=#f1f3f9>
     ...
     <form method="POST" action="add3">
      ...
      <p>漫游状态：<input type="radio" name="R1" value="省内漫游" checked>省内漫游 <input type="radio" name="R1" value="国内漫游">国内漫游 
      <input type="radio" name="R1" value="国际漫游">国际漫游</p>
      <p>通话级别：<input type="radio" value="本地电话" checked name="R2">本地通话 
      <input type="radio" name="R2" value="国内长途">国内长途 <input type="radio" name="R2" value="国际长途">国际长途</p>
      <p>客户ID：<input type="text" name="T2" size="20" placeholder="请输入用户Id"></p>
